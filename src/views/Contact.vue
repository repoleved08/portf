<template>
    ...
    <section class="relative z-10 overflow-hidden bg-white dark:bg-gray-700 px-12 lg:py-[120px]">
        <div class="container mx-auto">
            <div class="flex flex-wrap -mx-4 lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                                class="bg-blue-800 text-blue-300 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-gray-800 sm:p-12">
                        <form>
                            <div class="mb-6">
